...
def generate_report(y_true, y_pred, labels):
    ...
    macro_precision, macro_recall, macro_f1, _ = precision_recall_fscore_support(y_true, y_pred, average='macro',
                                                                                 zero_division=0)
    weighted_precision, weighted_recall, weighted_f1, _ = precision_recall_fscore_support(y_true, y_pred,
                                                                                          average='weighted',
                                                                                          zero_division=0)
...
# Plot confusion matrix and get the matrix
cm = plot_confusion_matrix(true_entities, pred_entities, labels)

# Generate confusion matrix report
cm_report = generate_confusion_matrix_report(cm, labels)

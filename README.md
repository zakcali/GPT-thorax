...
```
node test-bt5shot.js to prompt 100 test reports with Gemini 2.5 pro and five-shot prompt (bt prompt-5shot.html)
node test-btnshot.js to prompt 100 test reports with Gemini 2.5 pro and many-shot prompt (bt prompt-nshot.html) 
```
